...
import type { DecisionLearningRepository, MaterialDecisionInput } from "./decision-learning.js";

const userId = "10000000-0000-4000-8000-000000000001" as UserId;
const now = new Date("2026-09-04T12:00:00.000Z");
const input = (userMessage: string): MaterialDecisionInput => ({
  userId,
...
const repository = (): DecisionLearningRepository => ({
