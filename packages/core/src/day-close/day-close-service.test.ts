...
import type { DayCloseObservation, DayCloseRepository, DayCloseWorkflowRun } from "./day-close.js";

const userId = "10000000-0000-4000-8000-000000000001" as UserId;
const now = new Date("2026-09-04T14:00:00.000Z");
const observation: DayCloseObservation = {
  planId: "plan",
  planItems: [
...
describe("DayCloseService", () => {
  let repository: DayCloseRepository;
  let run: DayCloseWorkflowRun;
  ...
  const message = (text: string, messageId = "discord:close") => ({
