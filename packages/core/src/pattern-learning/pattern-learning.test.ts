...
import { derivePatternCandidates, type PatternLearningCase } from "./pattern-learning.js";

const item = (id: string, overrides: Partial<PatternLearningCase> = {}): PatternLearningCase => ({
  id,
