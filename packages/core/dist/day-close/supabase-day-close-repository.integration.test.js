...
beforeAll(async () => {
  ...
  `;
    const activeItem = await sql `select id from public.plan_items where daily_plan_id=${planId} and task_id=${activeTask}`;
    await sql `
...
//# sourceMappingURL=supabase-day-close-repository.integration.test.js.map