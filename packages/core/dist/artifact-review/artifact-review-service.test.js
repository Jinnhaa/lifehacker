...
const command = (decision, overrides = {}) => ({
...
const setup = (targetValue = target(), duplicate = false) => {
    ...
    const revision = { status: "waiting_for_review", agentRunId: "90000000-0000-4000-8000-000000000001", artifactId: "91000000-0000-4000-8000-000000000001", attemptNumber: 1 };
...
//# sourceMappingURL=artifact-review-service.test.js.map