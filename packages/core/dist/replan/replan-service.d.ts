...
import type { ReplanMessage, ReplanMessageHandler, ReplanMessageResult, DirectPlanEditRequest, DirectPlanEditResult, ReplanServiceDependencies } from "./replan.js";
export declare class DynamicReplanningService implements ReplanMessageHandler {
    ...
    editPlan(request: DirectPlanEditRequest): Promise<DirectPlanEditResult>;
