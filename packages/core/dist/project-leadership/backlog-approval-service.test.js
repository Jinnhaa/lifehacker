...
const item = (key) => ({
    ...
    suggestedPriority: "medium", suggestedOwner: "human", acceptanceCriteria: ["done"],
    dependencies: [], roughSize: "s", evidenceRefs: ["gap:gap-1"], risk: null
});
...
//# sourceMappingURL=backlog-approval-service.test.js.map