...
export const formatPrincipleProposal = (proposal) => [
    `이런 선택이 ${proposal.evidenceCount}번 반복됐어.`,
    `앞으로 비슷한 상황에서는 “${proposal.statement}”를 기준으로 삼도록 할까?`,
    "",
    "“승인”, “거절”, 또는 “수정: ...”으로 알려줘."
].join("\n");
export class PrincipleApprovalService {
    repository;
    clock;
    ...
    async afterPatternEvaluation(userId) {
...
//# sourceMappingURL=principle-approval-service.js.map