...
P0-4의 `0014_artifact_revision_link.sql`은 별도 Review table 없이 Artifact revision chain과 hybrid user review step의 명시적 연결만 추가한다. Review 판단과 이유는 기존 Decision/DecisionFeedback/DomainEvent에 저장한다.
